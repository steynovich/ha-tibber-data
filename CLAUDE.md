...
- 2025-11-11: Fixed critical entity availability issue after restart - entities now remain available even when capabilities are missing from first coordinator update, preventing "no longer provided" errors for hourly sensors after restart
