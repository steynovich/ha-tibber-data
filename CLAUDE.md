...
- 2025-11-11: Fixed WiFi connectivity sensors showing cellular attributes - WiFi sensors now only display WiFi-related attributes in extra_state_attributes, and cellular sensors only show cellular-related attributes, preventing attribute pollution across connectivity types
